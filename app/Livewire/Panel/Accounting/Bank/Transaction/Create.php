...
class Create extends Component
{
    ...
    #[On('accounting.bank.transaction.create.assign-data')]
    public function assignData($id): void
    {
        $this->bank_id = $id;
        Flux::modal('accounting.bank.transaction.create.modal')->show();
    }
    ...
    public function create()
    {
        ...
        Flux::modal('accounting.bank.transaction.create.modal')->close();
    ...
    {
        return view('livewire.panel.accounting.bank.transaction.create');
    }
}
