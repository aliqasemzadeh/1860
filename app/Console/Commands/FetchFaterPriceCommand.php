...
class FetchFaterPriceCommand extends Command
{
    protected $signature = 'fater:price {url : The faterco.ir product URL} {--debug : Show detailed debugging information}';

    protected $description = 'Fetch product price from faterco.ir';
    ...
    public function handle(): int
    {
        ...
        try {
            $price = FaterPriceFetcher::fetchPrice($url, $debug ? $this : null);
