...
<div>
    <section class="py-8 antialiased md:py-12">
        <div class="mx-auto max-w-7xl px-4 2xl:px-0">
            ...
            @else
                <div class="flex items-center justify-between mb-6 mt-12 border-t border-zinc-100 dark:border-zinc-800 pt-8">
                    <div class="flex items-center gap-3">
                        <div class="w-2 h-8 rounded-full bg-teal-600"></div>
                        <flux:heading size="xl">{{ __('general.products') }}</flux:heading>
                    </div>
                    <flux:carousel.controls name="dashboard-products-carousel" />
                </div>

                <flux:carousel name="dashboard-products-carousel" class="-mx-4" :arrows="false" track:class="px-4 scroll-px-4">
