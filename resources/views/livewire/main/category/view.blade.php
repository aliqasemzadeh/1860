...
<div>
    <section class="py-8 antialiased md:py-12">
        <div class="mx-auto max-w-7xl px-4 2xl:px-0">
            ...
            <div class="mb-6 bg-zinc-50 dark:bg-zinc-900 rounded-lg p-4 border border-zinc-200 dark:border-zinc-800">
                <div class="flex flex-col lg:flex-row gap-4 items-start lg:items-center justify-between">
                    ...
                    <div class="flex flex-wrap gap-4 flex-1">
                        ...
                        <div class="flex gap-2 items-end">
                            ...
                            <div class="text-xs text-zinc-500 pb-5">
                                {{ __('app.toman') }}
                            </div>
                        </div>

                        {{-- Clear Filters --}}
                        @if($this->brandId || $this->minPrice || $this->maxPrice)
                    ...
                    <div class="flex items-center gap-2">
                        <flux:text class="text-sm text-zinc-600 dark:text-zinc-400 whitespace-nowrap">
                            {{ __('app.sort_by') }}:
                        </flux:text>
                        <flux:select
                    ...
                    @foreach($this->products as $product)
                        ...
                        >
                            <flux:card class="h-full flex flex-col p-1">
                                <div
                                    class="relative aspect-square w-full overflow-hidden bg-zinc-100 dark:bg-zinc-800 rounded-t-lg">
                                            ...
                                            <div class="flex items-center justify-center gap-2">
                                                @if($product->sale_price && $product->sale_price < $product->price)
                                                    <div class="flex flex-col items-center">
                                                        ...
                                                        <div
                                                            class="text-sm text-zinc-400 dark:text-zinc-500 line-through">
