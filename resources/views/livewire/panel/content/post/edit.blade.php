<div>
    <flux:modal name="panel.content.post.edit.modal" class="md:w-2/3" flyout position="right">
        <div class="space-y-6">
            <div>
                <flux:heading size="lg">{{ __('general.edit_post') }}</flux:heading>
                <flux:text class="mt-2">{{ __('general.edit_post_description') }}</flux:text>
            </div>
                        ...
                        <flux:field>
                            ...
                            >
                                ...
                                @foreach ($this->tags as $tag)
                                    <flux:pillbox.option value="{{ $tag }}" wire:key="edit-tag-{{ $loop->index }}">
                                        {{ $tag }}
                                    </flux:pillbox.option>
                                @endforeach
                            </flux:pillbox>
