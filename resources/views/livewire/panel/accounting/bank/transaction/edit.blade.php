<flux:modal name="accounting.bank.transaction.edit.modal" class="md:w-96" flyout position="right">
    <div class="space-y-6">
        <div>
            <flux:heading size="lg">{{ __('app.edit_transaction') }} : {{ isset($id) ? '#' . $id : '' }}</flux:heading>
            <flux:text class="mt-2">{{ __('app.edit_transaction_description') }}</flux:text>
        </div>
