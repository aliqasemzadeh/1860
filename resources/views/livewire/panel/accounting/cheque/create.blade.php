<flux:modal name="accounting.cheque.create.modal" class="md:w-96" flyout position="right">
    <div class="space-y-6">
        <div>
            <flux:heading size="lg">{{ __('app.create_cheque') }}</flux:heading>
            <flux:text class="mt-2">{{ __('app.create_cheque_description') }}</flux:text>
        </div>
