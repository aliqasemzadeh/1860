<flux:modal name="panel.shop.shipping.method.edit.modal" class="md:w-96" flyout position="right">
    <div class="space-y-6">
        <div>
            <flux:heading size="lg">
                {{ __('general.edit_shipping_method') }} : {{ isset($name) ? $name : '' }}
            </flux:heading>
            <flux:text class="mt-2">{{ __('general.edit_shipping_method_description') }}</flux:text>
        </div>
            ...
            <div class="pb-2 space-y-3">
                ...
                <flux:field>
                    ...
                    <flux:text class="mt-1 text-xs text-gray-500">
                        {{ __('general.shipping_handle_help') }}
                    </flux:text>
