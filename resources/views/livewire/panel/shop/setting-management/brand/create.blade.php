<flux:modal name="panel.shop.setting-management.brand.create.modal" class="md:w-96" flyout position="right">
    <div class="space-y-6">
        <div>
            <flux:heading size="lg">{{ __('app.create_brand') }}</flux:heading>
            <flux:text class="mt-2">{{ __('app.create_brand_description') }}</flux:text>
        </div>
