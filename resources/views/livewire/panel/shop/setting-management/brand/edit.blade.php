<flux:modal name="panel.shop.setting-management.brand.edit.modal" class="md:w-96" flyout position="right">
    <div class="space-y-6">
        <div>
            <flux:heading size="lg">{{ __('app.edit_brand') }}</flux:heading>
            <flux:text class="mt-2">{{ __('app.edit_brand_description') }}</flux:text>
        </div>
