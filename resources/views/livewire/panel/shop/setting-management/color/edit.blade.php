<flux:modal name="panel.shop.setting-management.color.edit.modal" class="md:w-96" flyout position="right">
    <div class="space-y-6">
        <div>
            <flux:heading size="lg">{{ __('general.edit_color') }}</flux:heading>
            <flux:text class="mt-2">{{ __('general.edit_color_description') }}</flux:text>
        </div>
            ...
            <div class="pb-2 space-y-3">
                ...
                <flux:field>
                    ...
                    <div
                        x-data="{
                          defaultColor: '#14b8a6',
                          color: $wire.entangle('hex'),
                          textInput: null,
                          message: null,
                          init() {
                            const convertedColor = this.colorToHex(this.color ?? this.defaultColor);
