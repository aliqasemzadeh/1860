<flux:modal name="shop.setting-management.attribute-group.attribute.option.edit.modal" class="md:w-96" flyout position="right">
    <div class="space-y-6">
        <div>
            <flux:heading size="lg">{{ __('app.edit_attribute_option') }} : {{ isset($label) ? $label : '' }}</flux:heading>
            <flux:text class="mt-2">{{ __('app.edit_attribute_option_description') }}</flux:text>
        </div>
