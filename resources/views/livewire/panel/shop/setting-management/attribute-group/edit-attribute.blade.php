<flux:modal name="shop.setting-management.attribute-group.attribute.edit.modal" class="md:w-[600px]" flyout position="right">
    <div class="space-y-6">
        <div>
            <flux:heading size="lg">{{ __('app.edit_attribute') }} : {{ isset($label) ? $label : '' }}</flux:heading>
