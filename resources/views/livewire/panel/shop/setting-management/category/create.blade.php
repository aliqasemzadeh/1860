<flux:modal name="shop.setting-management.category.create.modal" class="md:w-96" flyout position="right">
    <div class="space-y-6">
        <div>
            <flux:heading size="lg">{{ __('app.create_category') }}</flux:heading>
            <flux:text class="mt-2">{{ __('app.create_category_description') }}</flux:text>
        </div>
