<flux:modal name="shop.product.create.modal" class="md:w-2/3" flyout position="right">
    <div class="space-y-6">
        <div>
        ...
        <form wire:submit="create" method="post">
            <div class="grid grid-cols-2 gap-6">
                <!-- Column 1: name, description, category_id, brand_id, unit_id, file -->
                <div class="space-y-3">
                    <flux:field>
                ...
                <!-- Column 2: slug, slug_fa, weight, dimensions -->
                <div class="space-y-3">
                    <flux:field>
